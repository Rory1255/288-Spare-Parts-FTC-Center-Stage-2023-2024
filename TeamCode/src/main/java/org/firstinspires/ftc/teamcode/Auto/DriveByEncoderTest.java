 ...
 */
@Disabled
@Autonomous(name="Drive By Encoder test", group="Robot")
public class DriveByEncoderTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //Left Odo: left rear drive
        //Middle Odo: right front drive
        //Right Odo: left front drive
        ...
        telemetry.addData("Starting at",  "%7d :%7d",
                leftRearDriveMotor.getCurrentPosition(),
